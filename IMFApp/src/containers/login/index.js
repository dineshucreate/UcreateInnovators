...
import { Image, ImageBackground, TouchableOpacity, Text, TextInput, View, ScrollView } from 'react-native';
        ...
        return (
            <ScrollView contentContainerStyle={{ flex: 1 }}>
                <ImageBackground style={styles.backgroundImage} source={require('../../assets/images/background.png')}>
                    <TouchableOpacity style={styles.backButton} onPress={this.backPress}>
